...
if __name__ == '__main__':
    ...
    wandb.log({"map50_95": map50_95, "map50": map50, "map75": map75, "mAP of 0": map_by_class[0]})
    
    data_path = 'cfg/datasets/detect/colored/val2017-single.yaml'
    ...
    output_directory = 'datasets/detect/val2017_single/images'
    ...
    # opacities = [0.25]
    test_img = "/home/cipoll17/POLO/datasets/detect/val2017_single/images/000000012639.jpg"
